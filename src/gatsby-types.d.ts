...
type BlogPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }>, readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<Pick<Frontmatter, 'title' | 'date' | 'description' | 'tags'>>, readonly wordCount: Maybe<Pick<MarkdownWordCount, 'words'>>, readonly headings: Maybe<ReadonlyArray<Maybe<Pick<MarkdownHeading, 'value' | 'depth'>>>> }
